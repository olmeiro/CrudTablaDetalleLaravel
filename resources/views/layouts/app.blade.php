  ...
  <body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show kreemo-sidebar" id="sidebar">
      ...
      <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/categorias">
        <i class="fas fa-home"></i> Categoria</a></li>
      <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/producto">
        <i class="fas fa-home"></i> Productos</a></li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/productoinsumo">
        <i class="fas fa-home"></i> Productos Insumos</a></li>
    
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/insumo">
        <i class="fas fa-user"></i> Insumos</a></li>
        ...
        <!-- <li class="c-sidebar-nav-item c-sidebar-nav-dropdown c-show"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="/">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="#cil-puzzle"></use>
            </svg> Base</a>
          <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href=""><span class="c-sidebar-nav-icon"></span> Breadcrumb</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href=""><span class="c-sidebar-nav-icon"></span> Cards</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href=""><span class="c-sidebar-nav-icon"></span> Carousel</a></li>
          </ul>
        </li> -->
          ...
          <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
              ...
              <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                ...
                </svg> Lock Account</a><a class="dropdown-item" href="javascript:document.getElementById('logout').submit()">
                <svg class="c-icon mr-2">

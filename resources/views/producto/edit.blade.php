...
@section('body')
    <div class="card">
        ...
        <form action="/producto/actualizar" method="POST" enctype="multipart/form-data">
        @csrf  
            ...
            <div class="row">         
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input value="{{$producto->nombre_producto}}" type="text" class="form-control @error('nombre_producto') is-invalid @enderror"  name="nombre_producto">
